...
supermarket_info_dictionary = {'mega':
{'store_name': 'mega',
...
'branch_url':
f''''http://publishprice.mega.co.il/{str(datetime.today().strftime("%Y%m%d"))}
/Stores7290055700007-{str(datetime.today().strftime("%Y%m%d"))}0001.xml''',
...
FileObject/UpdateCategory?catID=2&storeId=0&sort=Category&sortdir=ASC&page=1''',
                'multiple_pages': True,
                ...
                'item_date_format': '%Y-%m-%d',
                'branch_url':
                'http://prices.shufersal.co.il/FileObject/UpdateCategory?catID=5&storeId=0&page=1',
